...
document.getElementById("count").innerHTML = (`&copy; 26-06-2024 Developed By Muhammad Rasool. All Rights Reserved. Present: ${formattedDate}.<p class = "count"> Developed Passed ${countDate.days} Days.</P>`);
